...
// tampilkan expiry terdekat (hanya yang pertama di array)
...
void seedDummy(BST &T) {
    ...
    // tambahkan satu expiry pada produk tertentu (maks 1 expiry per produk)
    address a = searchNode(T, "Milk");
    if (a != Nil) { a->info.expiry[0] = "15-01-2026"; a->info.jumExpiry = 1; }
    a = searchNode(T, "IceCream");
    if (a != Nil) { a->info.expiry[0] = "10-02-2026"; a->info.jumExpiry = 1; }
}
